...
We share an interest, in my terms, in how we can construct meaningful actions in mediated social spaces and how we can understand mutual awareness (which I call grounding). 
...
As Erickson and Kellogg point out, they are hardly the only people to be interested in constructing meaningful actions and action contexts in collaborative systems. \citep{some_other_stuff_here_that_they_cite}.
