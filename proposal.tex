...
My survey of related work is organized by three major design strategies that are well-represented in the literature: translucence and awareness, adding new communication channels, and design techniques to help people reflect on their own participation and the participation of others. Each of these projects relates to one or more of my three research themes. As I discuss these projects, I will point out (as appropriate) their connections to the main research themes. Table \ref{tab:related-work} summarizes the major work covered in this section, and its relationship with the three themes. 
