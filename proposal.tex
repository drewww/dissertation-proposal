...
While the reflection-oriented projects discussed earlier are about augmenting an existing primary communication channel with additional information, there is also a large body of work that focuses on adding communication channels to an existing communication channel, as well as creating new kinds of primary communication channels.
