...
% do the table here
% \bullet \medbullet \centerdot \filledcircle \filledbigcircle
...
\begin{tabular}{rcccl}
\toprule
 & Grounding & Actions & Attention \\
\midrule
\emph{Loops, Babble, Lecture} & 1 & 2 & 0 & \citep{Erickson:2000kb} \\
\emph{Group SketchPad} & 1 & 2 & 1 & \citep{Gutwin:2002tf} \\
\emph{CafeCK} & 1 & 2 & 1 & \citep{Ackerman:1995tj} \\
Airplane Cockpits & 2 & 2 & 2 & \citep{Hutchins:1995ud} \\
\emph{ClearBoard} & 2 & 1 & 0 & \citep{Ishii:1992bq} \\
Classroom Chat Backchannels & 0 & 0 & 1 & \citep{Yardi:2006uk} \\
Conference Chat Backchannels & 0 & 0 & 1 & \citep{McCarthy:2004im} \\
Semi-Public Displays & 1 & 1 & 1 & \citep{Huang:2003ef} \\
\emph{Rendezvous} & 1 & 1 & 0 & \citep{Kellogg:2006vn} \\
Private Audio Backchannels & 0 & 1 & 1 & \citep{Yankelovich:2005bx} \\
\emph{VideoWindow} & 1 & 0 & 1 & \citep{Fish:1990fn} \\
\emph{Thunderwire} & 0 & 1 & 2 & \citep{Hindus:1996cn} \\
\emph{iCom} & 1 & 1 & 1 & \citep{Agamanolis:2006vh} \\
\emph{Portholes} & 1 & 0 & 1 & \citep{Dourish:1992fu} \\
\emph{Cruiser} & 0 & 2 & 1 & \citep{Fish:1992vz} \\
Group Decision Support Systems & 2 & 1 & 0 & \citep{Nunamaker:1991gk} \\
\emph{Second Messenger} & 1 & 0 & 0 & \citep{DiMicco:2007ie} \\
\emph{Meeting Mediator} & 1 & 0 & 0 & \citep{Kim:2008ip} \\
\emph{Conversation Clusters} & 1 & 0 & 1 & \citep{Bergstrom:2009fe} \\
\emph{Conversation Votes} & 1 & 1 & 1 & \citep{Bergstrom:2009ej} \\
\emph{Conversation Clock} & 1 & 0 & 1 & \citep{Bergstrom:2007je} \\
\bottomrule
\end{tabular}
