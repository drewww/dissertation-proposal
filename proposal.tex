...
\begin{abstract}
\noindent Although it's been 20 years since the ``beyond being there'' argument was first made, most of our communication and collaboration experiences have retained their focus on recreating face-to-face interaction. In this proposal, I outline my strategy for designing interfaces that move beyond face-to-face experiences by creating new mediated communication channels that co-exist with other existing synchronous communication experiences (face-to-face or mediated) and used shared displays to help support creating common ground among users. I illustrate these design strategies using a series of three past projects: \emph{Information Spaces}, \emph{backchan.nl}, and \emph{Tin Can Classroom} and describe a future project that ties these strategies together: \emph{Tin Can Conference}. In each of these projects I trace my three major research themes: grounding, non-verbal actions, and attention and identify the major contributions that my work will make.
\end{abstract}
...
The timeline laid out in table \ref{tab:timeline} is quite rough. Much of this work will be happening in parallel, but it is useful, at least, to list the major milestones between now and graduating even if the dates are relatively loose.
