...
We have long depended on voice and video to mediate our synchronous communication and collaboration activities. While these channels can be quite effective, their focus on communication styles that mimic face-to-face interaction can have important negative consequences; face-to-face interactions in medium sized groups have a number of structural challenges that can be alleviated by designing complementary secondary communication channels. In this proposal, I outline the potential impacts of these channels and my findings relating to how they are appropriated in authentic user contexts. I illustrate the design strategies I have employed using a series of projects: \emph{backchan.nl}, and \emph{Tin Can Classroom} and describe my current project that ties these strategies together: \emph{Tin Can Conference}. In each of these projects I trace the influence of my three major research themes: grounding, non-verbal actions, and attention.
\end{abstract}
...
I have explored my primary theme of adding communication channels to synchronous communication through a series of design research projects. In each piece, I focus on different contexts, group sizes, and needs. In this section, I will describe my three of the projects that my dissertation will cover: \emph{backchan.nl}, \emph{Tin Can Classroom}, and \emph{Tin Can Conference}. \sidenote{A fourth project, \emph{Information Spaces}, will also be part of the dissertation, but is omitted here for the sake of brevity. It is described in some depth in \citep{Harry:2008ww}. Other virtual world related work on representational technique and metaphor can be found in \citep{Harry:2008tg}, \citep{Harry:2007cm}, and \citep{Harry:2008vx}.}
...
%Since \emph{backchan.nl} was first designed, \citet{Bergstrom:wl} has described a system with similar properties, but for more structured environments like a lecture class.}
